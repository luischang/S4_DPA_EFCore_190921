...
using S5_DPA_MVCEFCORE.DatabaseFirst.Models;

namespace S5_DPA_MVCEFCORE.DatabaseFirst.Controllers
{
    public class ProductController : Controller
    {
        ...
        {
            var salesDBContext = _context.Product.Include(p => p.Supplier);
